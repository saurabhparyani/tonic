              ...
              <div>
                <div className="lg:w-[570px]">
                  ...
                  <p className="text__para">
                    Connect with trusted doctors and build a lasting
                    relationship for your ongoing health needs. Get same-day
                    appointments without leaving the comfort of your home.
                  </p>
                  <button className="btn font-[600]">
          ...
          <div className="container">
            <div className="lg:w-[470px] mx-auto ">
              ...
              <p className="text__para text-center">
                Experience the benefits of our compassionate care: faster
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
              ...
              <div className="py-[30px] px-5">
                ...
                <div className="mt-[30px]">
                  ...
                  <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                    Quality care close to home. Find a location near you.
                  </p>
                  <Link
                    to="/doctors"
                    className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex  items-center justify-center group  hover:bg-primaryColor hover:border-none"
        ...
        <section>
          <div className="container">
            <div className="xl:w-[470px] mx-auto">
              ...
              <p className="text__para text-center">
                Tonic offers a comprehensive range of medical services designed
                to meet your diverse healthcare needs. Our expert teams provide
                personalized care across a wide variety of specialties.
              </p>
            </div>
            <ServiceList />
          </div>
        ...
        <section>
          <div className="container">
            <div className="xl:w-[470px] mx-auto">
              ...
              <p className="text__para text-center">
                Discover our team of experienced physicians passionate about
